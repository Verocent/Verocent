...
export const ACCESS_MODULES = {
  'Founder / CEO':        ['dashboard','products','production','inventory','sales','finance','compliance','staff','reports','audit','documents'],
  'Production Manager':   ['dashboard','products','production','inventory','documents'],
