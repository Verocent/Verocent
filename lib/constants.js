...
export const MODULES = [
  ...
  { id: 'documents',   icon: '📋', label: 'Documents & SOPs'  },
...
export const RM_CATEGORIES = [
  'Butter','Essential Oil','Carrier Oil','Herb','Spice','Extract',
  'Preservative','Packaging-Bottle','Packaging-Jar','Packaging-Tub',
  'Packaging-Label','Other',
];
